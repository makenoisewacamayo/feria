        ...
        <div class="row mb-2">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-danger direct-chat direct-chat-danger">
              ...
              <?php
			  $AllMsgSql=mysqli_query($conn,"SELECT m.*,u.name as fromsendername,l.list_name FROM `messages` m LEFT JOIN users u ON u.id=m.from_id LEFT JOIN list_master l ON l.id=m.list_id WHERE (m.from_id='".$_SESSION['userid']."' AND m.list_id='".$_GET['list_id']."' and m.to_id='".$_GET['sub_cust_id']."') OR (m.from_id='".$_GET['sub_cust_id']."' AND m.list_id='".$_GET['list_id']."' and m.to_id='".$_SESSION['userid']."') GROUP by m.send_time ORDER BY m.send_time ASC");
		   $AllMsgArr=array();
		   ...
		   <?php } ?>
              ...
              <div class="card-footer">
				...
				<input type="hidden" id="cur_list_id" name="cur_list_id" value="<?php echo $_GET['list_id'];?>">
				<input type="hidden" id="to_message_id" name="to_message_id" value="<?php echo $_GET['sub_cust_id'];?>">
